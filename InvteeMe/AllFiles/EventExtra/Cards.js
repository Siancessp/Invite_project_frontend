  ...
  return (
      ...
      <View
        ...
        <View
          ...
          <View style={styles.box1}>
            <Text style={styles.t3}>7 - 11</Text>
            <Text style={styles.t4}>December</Text>
    ...
    <View
      ...
      <View style={styles.box2}>
        <Text style={{color:"#B84747", fontSize:20, fontWeight:"500"}}>₹3000 <Text style={{fontSize:14,color:"#585858", fontWeight:"400"}}>/per person </Text></Text>
        <TouchableOpacity style={styles.btn} onPress={()=> navigation.navigate("EventBooking")}>
          <Text style={{color:"white", fontSize:18}}>Book Ticket</Text>
        </TouchableOpacity>
      </View>
    </View>
  );
