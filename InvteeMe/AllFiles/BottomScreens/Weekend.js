...
const Weekend = ({navigation}) => {
  ...
  return (
    <View style={{}}>
    <ImageBackground 
      source={require("../../assets/weekend.png")}
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        <Text style={styles.t1}>
          Let's pack for your
          <Text style={{color: '#B84747'}}> Weekend Trip</Text>
        </Text>
        ...
        <View style={styles.l1}>
          <Text style={styles.t2}>Ongoing Trip</Text>
        </View>
        <TouchableOpacity
          style={{
          ...
          <ImageBackground
            ...
            <View
              ...
              <Text style={styles.t9}>3 days, 2 nights</Text>
        ...
        <View style={styles.l1}>
          <Text style={styles.t2}>Categories</Text>
        </View>
        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
          {cat.map(items => (
            <TouchableOpacity
              style={styles.cat}
              onPress={() =>
                navigation.navigate('CategoryPage', {catName: items.catName})
              }>
        ...
        <ScrollView horizontal showsHorizontalScrollIndicator={false}>
          {posts.map(items => (
            <TouchableOpacity
              style={styles.box2}
              onPress={() =>
                navigation.navigate('WeekendDetails', {name: items.name})
              }>
              <ImageBackground
                source={items.photo}
                style={styles.img}
