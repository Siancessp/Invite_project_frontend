import {
  ...
  const WeekendBooking = ({navigation}) => {
      ...
      <View
        ...
        <ScrollView style={{margin: 10}}>
          ...
          <View style={{marginTop: 30, marginHorizontal: 10}}>
            <Text style={styles.t2}>Travel Via</Text>
            <DropDownPicker
              items={items}
              open={isOpen}
              setOpen={dropdown1}
              ...
              textStyle={styles.t1}
            />
            <Text style={{...styles.t2, marginTop: isOpen ? 160 : 20}}>From</Text>
            <TextInput placeholder="Onboarding" style={styles.input} />
            <Text style={{...styles.t2, marginTop: 20}}>To</Text>
            <TextInput placeholder="Destination" style={styles.input} />
  
            <Text style={{...styles.t2, marginTop: 20}}>Date</Text>
            ...
            <Text style={styles.t2}>Number of people</Text>
            ...
            <Text style={{...styles.t2, marginTop: 20}}>Payment Methods</Text>
            <DropDownPicker
              items={items}
              open={isOpen2}
              setOpen={dropdown2}
